...
#import "../vkpassprefs/VKPassLP.h"
/////VK NON-JB/////
//#define passcodePath [NSHomeDirectory() stringByAppendingString:@"/Documents/ru.anonz.vkpasscode.plist"]
//#define prefsBundleFile [NSHomeDirectory() stringByAppendingString:@"/Documents/ru.anonz.vkpassprefs.plist"]

///////VK JB///////
//#define passcodePath @"/var/mobile/Library/Preferences/ru.anonz.vkpasscode.plist"
//#define prefsBundleFile @"/var/mobile/Library/Preferences/ru.anonz.vkpassprefs.plist"
...
typedef enum : NSUInteger {
    ...
    BKPasscodeViewControllerCheckDisablePasscodeType,
    BKPasscodeViewControllerCheckDialogsPasscodeType,
    BKPasscodeViewControllerDisableDialogsPasscodeType,
    BKPasscodeViewControllerDeletePasscodeType
